...
//        userInfo.setUserId("19981101");
        userInfo.setUserName("刘天俊");
        userInfo.setPassword("11114444");
        userInfo.setEmail("1216226917@qq.com");
        userInfo.setAge(21);
        userInfo.setPhone("acavkav4");
        Calendar calendar = Calendar.getInstance();
        calendar.set(2019, 5, 1);
        userInfo.setBirthday(calendar.getTime());

        UserInfo friend = new UserInfo();
        friend.setUserId("19981002");
        friend.setUserName("王萌萌");
        friend.setPassword("11245454");
    ...
    public void constructorValidation() throws NoSuchMethodException {
        ...
        //校验构造器
        otherSet=executableValidator.validateConstructorParameters(constructor,params);
    }
}
